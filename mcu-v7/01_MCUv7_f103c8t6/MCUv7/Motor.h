...
#define MOTOR_TIMER_FREQ_Hz			(uint32_t)(2000 * 1000)	//частота тактироваия базового таймера в Гц.

#define MOTOR_ONE_FULL_STEP_DEGREE	1.8f 					//Шаг мотора(в градусах)										  //угол поворота мотора за один полный шаг.
...
#define MOTOR_RPM_MAX				1200	//скорость в RPM
 ...
 */
typedef struct {
	MotorState_t state;	  		//! What part of the speed ramp we are in.
