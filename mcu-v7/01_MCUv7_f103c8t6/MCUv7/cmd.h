...
typedef enum{
    ...
    cmdSetTargetPosition = 0x03, //Задать целевое положение, в градсах.
     	 	 	 	 	 	 	 //На сколько градусов нужно повернуть вал ШД.
								 //Учитывается передаточное число редуктора.

//	cmdSetAcceleration = 0x04,   //задать ускорение, оборотов в минуту за минуту - Неудобный вариант задания ускорения.
	cmdSetAccelTime    	= 0x04,  //Задать время в течении которого будет происходить ускорение, в мС.

	cmdSetMaxVelocity 	= 0x05,  //задать максимальную скорость, в оборотах в минуту (RPM)
